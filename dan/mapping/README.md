# MapViz + Google Maps Satellite +  MapProxy
This will walk you through using MapProxy to proxy Google Maps satellite view to a WMTS tile service so that it can be viewed in ROS MapViz.
